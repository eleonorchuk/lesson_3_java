...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        shiftElements(new int[]{3, 5, 6, 1}, -2);
        shiftElements(new int[]{77}, 10);
        shiftElements(new int[]{10,0}, 2);
        shiftElements(new int[]{10,0}, -2);
    }
    ...
    */
    ...
    При каком n в какую сторону делать сдвиг - можете выбирать сами.
    */
    ...
    public static void shiftElements(int[] arr, int n) {
        System.out.println("shiftElements");
        System.out.println("Input array  = " + Arrays.toString(arr));
